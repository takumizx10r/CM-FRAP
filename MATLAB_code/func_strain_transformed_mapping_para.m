function [myMovie,PI_Strain, K_all] = func_strain_transformed_mapping_para(inputTensor_list,  inputimage, Iter, frame,ABSPATH_Tensor,outextension,outpath,indx_outlier)
...
for posi=1:length(inputTensor_list)
    ...
    if Iter<=sz(1)
        ...
        PI_Strain(posi,1)=strain_parallel(Iter,1);
