function [MAX ,MIN,f] = func_make_rectangle_strainTransformed_field_perp(inputimage, iter, RAB_Frame,  Vector,pixelsize, time)
...
text(80.0/1024*im_size/2,130.0/1024*im_size,strcat('\fontsize{16} \fontname{Arial}10 ',char(181),'m'), 'HorizontalAlignment','center','Rotation',90, 'Color','white', 'FontWeight','normal');
