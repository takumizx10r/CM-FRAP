function [MAX ,MIN,f] = func_make_rectangle_strain_field_ver2(inputimage, iter, RAB_Frame,  Vector,pixelsize, time)
...
text(80/1024*im_size/2,130/1024*im_size,strcat('\fontsize{16} \fontname{Arial}10 ',char(181),'m'), ...
    'HorizontalAlignment','center','Rotation',90, 'Color','white', 'FontWeight','normal');
text(130/1024*im_size,80/1024*im_size/2,strcat('\fontsize{16} \fontname{Arial}10 ',char(181),'m'), ...
    'HorizontalAlignment','center', 'Color', 'white', 'FontWeight','normal');
time_str=strcat(sprintf('%d (s)',time));
text(900/1024*im_size , 80/1024*im_size/2,time_str,'FontName','Arial','FontSize',20, 'HorizontalAlignment','center', 'Color','white', 'FontWeight','normal');
axtoolbar('Visible','off');          
